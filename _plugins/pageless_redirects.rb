...
<html lang="en">
  ...
  <body>
    <header>
      <a href="/">
        <img src="/images/logo/atoum.png" alt="atoum" />
      </a>
    </header>

    <article>
      <h1>Your are being redirected...</h1>

      <p class="header__paragraph"><a href="#{destination_path}">#{destination_path}</a></p>

      <script>setTimeout(function() { location="#{destination_path}"; }, 1000);</script>
